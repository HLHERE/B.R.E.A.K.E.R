<footer class="px-4 divide-y dark:bg-gray-800 dark:text-gray-100 bg-navbar">
	<div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div class="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
				<div class="flex items-center justify-center w-12 h-12">
					<svg class="flex-shrink-0 w-50 rounded-full dark:text-gray-900">
		...
		<div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div class="space-y-3">
				<h3 class="tracki uppercase dark:text-gray-50">Features</h3>
				<ul class="space-y-1">
					<li>
						<a rel="noopener noreferrer" href="#">Technology</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Game</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#">Anime</a>
					</li>
				</ul>
			</div>
			<div class="space-y-3">
	...
	<div class="py-6 text-sm text-center dark:text-gray-400">© 2022 GLamGroove. All rights reserved.</div>
</footer>
