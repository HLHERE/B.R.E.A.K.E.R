              ...
              <form class="space-y-4 md:space-y-6" action="/login" method="post">
                @csrf
                  ...
                  <div class="flex flex-col items-center">
                    ...
                    <a href="google" class="text-navbar bg-white shadow-xl hover:bg-navbar hover:text-white focus:ring-4 focus:outline-none focus:ring-navbar font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55">
