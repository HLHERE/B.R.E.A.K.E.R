...
<div class="max-w-screen-lg mx-auto">
  ...
  <div class="flex flex-col lg:flex-row lg:space-x-6">
    <div class="px-4 lg:px-0 -mt-36 text-gray-700 text-lg leading-relaxed w-full lg:w-3/4">
    ...
    <div class="container mb-4 md:mb-0 w-full mx-auto relative -mt-28 max-w-md">
      <img src="/../img/valor.jpg" class="w-full -mt-20 object-cover lg:rounded" />
    </div>
  </div>
  </main>
  <!-- main ends here -->
...
<div class="max-w-screen-lg mx-auto">
  <div class="flex flex-col lg:flex-row lg:space-x-6">
    <div class="px-4 lg:px-0 -mt-4 text-gray-700 text-lg leading-relaxed w-full">
      <p class="pb-6">Difficulty on insensible reasonable in. From as went he they. Preference themselves me as
        thoroughly
        partiality considered on in estimating. Middletons acceptance discovered projecting so is so or. In or
        attachment inquietude remarkably comparison at an. Is surrounded prosperous stimulated am me discretion
...
<!-- Halaman Bawah -->
<h1 class="text-4xl font-semibold leading-9 mt-10 text-center text-gray-800 dark:text-gray-50">Daftar Game</h1>
<!-- component -->
        ...
        <div class="lg:w-1/2">
          <div class="sm:flex items-center justify-between xl:gap-x-8 gap-x-6">
            <div class="sm:w-1/2 relative">
              ...
              <img src="/../img/Hujan.jpg" alt="hujan" class="w-full lg:rounded" alt="chair" />
            </div>
            ...
            <div class="sm:w-1/2 sm:mt-0 mt-4 relative">
              ...
              <img src="/../img/Gempa.jpg" class="w-full lg:rounded" alt="gempa" class="w-full" />
            </div>
          </div>
          ...
          <div class="relative">
            ...
            <img src="/../img/valor.jpg" alt="sitting place" class="lg:rounded w-full md:mt-9 hidden sm:block" />
          </div>
        </div>
        ...
        <div class="lg:w-1/2 xl:ml-8 lg:ml-4 lg:mt-0 md:mt-6 mt-4 lg:flex flex-col justify-between">
          <div class="relative">
            <div>
              ...
              <div class="absolute bottom-0 left-0 md:p-10 p-6">
                ...
                <a class="flex items-center mt-4 cursor-pointer text-white hover:text-gray-200 hover:underline">
                  <p class="pr-2 text-sm font-medium leading-none">Read More</p>
            ...
            <img src="/../img/AI.jpg" alt="sitting place" class="w-full sm:block hidden lg:rounded" />
          </div>
          ...
          <div class="sm:flex items-center justify-between xl:gap-x-8 gap-x-6 md:mt-6 mt-4">
            <div class="relative w-full">
              ...
              <img src="/../img/jujutsu.jpg" class="w-full lg:rounded" alt="chair" />
            </div>
            ...
            <div class="relative w-full sm:mt-0 mt-4">
              ...
              <img src="/../img/anthem.jpg" class="w-full lg:rounded" alt="wall design" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="lg:flex items-stretch md:mt-12 mt-8">
        ...
        <div class="lg:w-1/2 xl:ml-8 lg:ml-4 lg:mt-0 md:mt-6 mt-4 lg:flex flex-col justify-between">
          <div class="relative">
            ...
            <img src="/../img/AI.jpg" alt="sitting place" class="lg:rounded w-full sm:block hidden" />
          </div>
