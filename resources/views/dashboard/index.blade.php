        ...
        <div class="flex space-x-3 m-5">
          <a href="/dashboard/posts/create/" class="flex flex-col items-center bg-putih border border-white rounded-lg shadow md:flex-row md:max-w-md hover:bg-white dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            ...
            <div class="text-center">
              <div class="flex items-center justify-center w-10 h-10 mx-auto mb-3 rounded-full bg-navbar sm:w-12 sm:h-12">
                <svg class="w-6 h-6 text-putih dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
              ...
              <p class="text-gray-700 text-sm">
                Welcome back! Tens of thousands of users have logged into GlamGroove, making it a bustling hub for news and updates              </p>
            </div>
          </div>
