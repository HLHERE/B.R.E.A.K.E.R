...
<form method="post" action="/dashboard/posts" class="relative top-[125px] w-[900px] ">
    ...
    <select id="categories" name="categ" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-navbar focus:border-navbar block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-navbar dark:focus:border-navbar">
...
<div class="mb-5">
    ...
    <button type="submit" class="text-putih bg-navbar hover:bg-orange_muda focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-orange_muda dark:hover:bg-navbar dark:focus:ring-white">Create Blog!</button>
  </form>
