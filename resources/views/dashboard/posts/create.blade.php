...
@section('container')
    <form method="post" action="/dashboard/posts" class="relative top-[125px] w-[900px] " enctype="multipart/form-data">
        ...
        <div class="mb-5">
            ...
            <div class="mb-5">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="postImg">Upload
                    file</label>
            ...
            <button type="submit"
                class="mt-4 mb-5 text-putih bg-navbar hover:bg-orange_muda focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-orange_muda dark:hover:bg-navbar dark:focus:ring-white">Create
                Post!</button>
