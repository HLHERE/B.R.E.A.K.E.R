<div class=" top-[125px] w-[900px]  table-auto mt-5 ml-10">
    <!-- Search Form -->
    ...
    <!-- End Search Form -->
    <div
        class="overflow-x-auto overflow-y-hidden max-w-full md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl mt-4 ">
                        ...
                        <td class="px-6 py-4 flex justify-center space-x-1 max-w-sm">
                            <form action="/dashboard/user/{{ $user->id }}" method="post">
                                ...
                                <button type="submit"
                                    ...
                                    onclick="return confirm('Are you sure want to delete this User?')">Delete</button>
                            </form>
                        </td>
                    </tr>
