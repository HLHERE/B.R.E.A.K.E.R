<div class="mt-28 ml-80">
    ...
    <!-- Table Container -->
    <div class="overflow-x-auto overflow-y-hidden max-w-full md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl mt-4 mr-28">
                ...
                @foreach ($posts as $index => $post)
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 flex justify-center space-x-1 max-w-sm">
                            ...
                            <button onclick="window.location.href='/dashboard/posts/{{$post->slug}}/edit'" type="button" class="text-white bg-yellow-300 hover:bg-yellow-200 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 me-1 mb-1 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                Edit
                            </button>
                            <form action="/dashboard/posts/{{$post->slug}}" method="post">
                                @method('delete')
                                @csrf
                                <button type="submit" class="text-white bg-red-700 hover:bg-red-300 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 me-1 mb-1 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onclick="return confirm('Are you sure want to delete this?')">
                                    Delete
                                </button>
                            </form>
                        </td>
